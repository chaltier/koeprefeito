...
export default function Home() {
  ...
  return (
    <Layout showHeader={false}>
      <Head>
        <title>KoePrefeito - Plataforma Cidadã</title>
        <meta name="description" content="Plataforma de comunicação entre cidadãos e prefeitura" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-16">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-primary-600">transformação da cidade</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-600">
              Conecte-se diretamente com a prefeitura. Relate problemas, acompanhe soluções 
              e participe ativamente da melhoria do seu município.
            </p>
